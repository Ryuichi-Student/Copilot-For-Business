...
def display_session_ui(p):
    ...
    if session_manager.requires_autogenerated_session:
        session_manager.create_session(f"New Question", rerun=False)
...
with st.sidebar:
    ...
    new_session_button = nb_placeholder.button("Create new question", on_click=lambda: session_manager.use_session(session_manager.new_session), disabled=not st.session_state.get("disabled"))
...
if not session_manager.get_config(current_session_id, "query"):
    ...
    if userQuery:
        ...
        new_session_button = nb_placeholder.button("Create new question", on_click=lambda: session_manager.use_session(
