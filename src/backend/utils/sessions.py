...
class Session_Storage:
    ...
    @property
    def requires_autogenerated_session(self):
        return ((self.session_data is None) or
                (not self.session_data) or
                all("autogenerate" not in self.session_data[session] or not self.session_data[session]["autogenerate"] for session in self.session_data))
