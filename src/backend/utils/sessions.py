...
class Session_Storage:
    ...
    def update_session_name(self, session_id: str, query: str) -> Iterable[str]:
        ...
        """
        name = get_gpt_response(("user", f"""I want to generate a name for a GPT session, based on the user's query. Write down a short name (and nothing else) that describes and summarises the query: "{query}". Make sure that the name is descriptive about the query, but not about the other data, such as method or the word Session."""))
