...
def early_analysis(userQuery, db: Database):
    system_prompt = dedent('''\
        ...
        If the status is "schema", it indicates that the query can be resolved by only interpreting the schema itself. Please include in the message a detailed and insightful explanation that directly answers the user's query, leveraging the schema information. 
